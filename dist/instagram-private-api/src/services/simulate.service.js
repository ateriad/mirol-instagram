...
class SimulateService extends repository_1.Repository {
    ...
    static executeRequestsFlow({ requests, concurrency = 1, toShuffle = true, }) {
        return __awaiter(this, void 0, void 0, function* () {
            if (toShuffle) {
                requests = lodash_1.shuffle(requests);
            }
            yield Bluebird.map(requests, request => request(), { concurrency });
        });
    }
    preLoginFlow(concurrency, toShuffle) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    postLoginFlow(concurrency, toShuffle) {
        return __awaiter(this, void 0, void 0, function* () {
            return SimulateService.executeRequestsFlow({
